...
void pInterpolation(volScalarField& p, fvMesh& mesh, Time& runTime, int cwipiObsp, int nbParts,
interpolationCellPoint<double> triangulateCellsp, float cwipiVerbose, std::string globalPath, std::string pIntPath)
{
