...
#define CWP_VERSION       "0.12.0"
#define CWIPI_VERSION       "0.12.0"

#define CWP_VERSION_MAJOR 0
#define CWP_VERSION_MINOR 12
#define CWP_VERSION_PATCH 0

#define CWP_MAJOR_VERSION 0
#define CWP_MINOR_VERSION 12
...
! #undef CWP_HAVE_NOT_FORTRAN_IN_C
