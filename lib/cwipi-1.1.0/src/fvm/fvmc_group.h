#ifndef __FVMC_GROUP_H__
#define __FVMC_GROUP_H__
...
/*
  ...
  The structure contents are private, and are defined in fvmc_group.c
*/

typedef struct _fvmc_group_class_t     fvmc_group_class_t;
typedef struct _fvmc_group_class_set_t fvmc_group_class_set_t;
...
fvmc_group_class_set_t *
fvmc_group_class_set_destroy(fvmc_group_class_set_t  *this_class_set);
