#ifndef __FVMC_TO_MED_H__
#define __FVMC_TO_MED_H__
...
void *
fvmc_to_med_init_writer(const char                   *const name,
...
void
fvmc_to_med_set_mesh_time(void          *const this_writer,
                         const int            time_step,
...
void
fvmc_to_med_export_nodal(void               *const this_writer_p,
...
void
fvmc_to_med_export_field(void                      *const this_writer,
                        const fvmc_nodal_t         *const mesh,
