#ifndef __FVMC_SELECTOR_POSTFIX_H__
#define __FVMC_SELECTOR_POSTFIX_H__
...
typedef struct _fvmc_selector_postfix_t  fvmc_selector_postfix_t;
...
#endif /* __FVMC_SELECTOR_POSTFIX_H__ */
