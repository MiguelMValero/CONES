#ifndef __FVMC_WRITER_H__
#define __FVMC_WRITER_H__
...
typedef enum {
  ...
  FVMC_WRITER_FIXED_MESH,         /* Mesh definitions do not change with time */
  FVMC_WRITER_TRANSIENT_COORDS,   /* Vertex coordinates may change with time */
  FVMC_WRITER_TRANSIENT_CONNECT   /* Mesh connectivity may change with time */
...
typedef enum {
  ...
  FVMC_WRITER_PER_NODE,           /* Variable values per node */
  FVMC_WRITER_PER_ELEMENT,        /* Variable values per element */
  FVMC_WRITER_PER_PARTICLE        /* Variable values per particle */

} fvmc_writer_var_loc_t;

/*----------------------------------------------------------------------------
 * Opaque structure defining a writer definition
 *----------------------------------------------------------------------------*/

typedef struct _fvmc_writer_t fvmc_writer_t;
