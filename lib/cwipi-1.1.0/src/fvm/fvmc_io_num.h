#ifndef __FVMC_IO_NUM_H__
#define __FVMC_IO_NUM_H__
...
/*
  ...
  itself is private, and is defined in fvmc_io_num.c
*/

typedef struct _fvmc_io_num_t fvmc_io_num_t;
