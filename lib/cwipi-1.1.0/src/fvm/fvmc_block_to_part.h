#ifndef __FVMC_BLOCK_TO_PART_H__
#define __FVMC_BLOCK_TO_PART_H__
...
typedef struct _fvmc_block_to_part_t  fvmc_block_to_part_t;
...
fvmc_block_to_part_create_adj(MPI_Comm                  comm,
                             fvmc_block_to_part_info_t  adj_bi,
...
#endif /* __FVMC_BLOCK_TO_PART_H__ */
