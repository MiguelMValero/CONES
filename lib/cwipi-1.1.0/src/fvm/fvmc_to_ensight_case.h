#ifndef __FVMC_TO_ENSIGHT_CASE_H__
#define __FVMC_TO_ENSIGHT_CASE_H__
...
typedef struct _fvmc_to_ensight_case_t fvmc_to_ensight_case_t;
...
typedef struct {
  ...
  _Bool         queried; /* Indicates if this file name has already been
                            returned by "fvmc_to_ensight_case_get_..._file()"
...
#endif /* __FVMC_TO_ENSIGHT_CASE_H__ */
