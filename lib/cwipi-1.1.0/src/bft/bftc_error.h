#ifndef __BFTC_ERROR_H__
#define __BFTC_ERROR_H__
...
typedef void (bftc_error_handler_t) (const char    *const file_name,
                                    const int            line_num,
...
/*
 * Calls the error handler (set by bftc_error_handler_set() or default).
 *
...
/*
 * Returns the error handler associated with the bftc_error() function.
 *
 * returns:
...
/*
 * Associates an error handler with the bftc_error() function.
 *
 * parameters:
